...
build_options([{stream_from_file_chunk_size_bytes,V} | T], Opts) when is_integer(V) andalso (V > 0) ->
    build_options(T, Opts#elwhc_opts{stream_from_file_chunk_size_bytes = V});
