...
-record(elwhc_request, {method, purl, body, headers, options = #elwhc_opts{}, t0 = os:timestamp(), socket, request_ttg_ms, request_ttg_t0,  rsp_status, rsp_headers = [], rsp_body = <<>>, content_length = undefined}).
