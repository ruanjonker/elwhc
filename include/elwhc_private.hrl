...
-record(elwhc_opts, {connect_timeout_ms = 120000, request_timeout_ms = 300000, keepalive_ms = 30000, keepalive = false, tcp_connect_options = [binary, {packet, http}, {active, false}, {reuseaddr, true}, {nodelay, true}, {keepalive, true}], ssl_options = [], max_sessions = 5, max_requests_per_session = 1000, stream_from = undefined, stream_from_file_chunk_size_bytes = 65336}).
